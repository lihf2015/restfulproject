...
<title>Uikit Test</title>  
    ...
    <link rel="stylesheet" type="text/css"   href="<%=basePath%>plugins/uikit/css/uikit.gradient.min.css">  
    <link rel="stylesheet" type="text/css" href="<%=basePath%>plugins/uikit/css/components/notify.gradient.min.css">  
</head>  
<body>  
<div  
...
<script type="text/javascript" src="<%=basePath%>plugins/uikit/js/uikit.min.js"></script>  
<script type="text/javascript" src="<%=basePath%>plugins/uikit/js/components/notify.min.js"></script>  
